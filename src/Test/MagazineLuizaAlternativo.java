...
public class MagazineLuizaAlternativo {
	...
	public void test() throws InterruptedException {
		...
		Thread.sleep(5000);
		WebElement furtoRoubo = driver.findElement(By.xpath("//input[@name = 'roubo-e-furto']"));
		furtoRoubo.click();
		
		Thread.sleep(5000);
		WebElement garantia = driver.findElement(By.xpath("//input[@id = 'one-year-warranty']"));
		garantia.click();
